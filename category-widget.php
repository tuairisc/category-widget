...
require_once(dirname(__FILE__) . 'category_widget_functions.php');
...
class Bhalash_Category_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('Tuairisc: Home Page Category', 'bhalash'),
            array(
                'description' => __('Selected category to featured on the website home page', 'bhalash'),
            )
        );
    }
...
add_action('widgets_init', create_function('', 'return register_widget("Bhalash_Category_Widget");'));
